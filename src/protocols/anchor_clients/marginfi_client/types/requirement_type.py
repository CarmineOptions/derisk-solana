...
RequirementTypeKind = typing.Union[Initial, Maintenance, Equity]
RequirementTypeJSON = typing.Union[InitialJSON, MaintenanceJSON, EquityJSON]


def from_decoded(obj: dict) -> RequirementTypeKind:
...
def from_json(obj: RequirementTypeJSON) -> RequirementTypeKind:
    if obj["kind"] == "Initial":
        return Initial()
