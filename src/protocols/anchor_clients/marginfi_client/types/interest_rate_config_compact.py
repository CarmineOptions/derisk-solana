...
class InterestRateConfigCompactJSON(typing.TypedDict):
...
@dataclass
class InterestRateConfigCompact:
    ...
    @classmethod
    def from_decoded(cls, obj: Container) -> "InterestRateConfigCompact":
        return cls(
    ...
    def to_json(self) -> InterestRateConfigCompactJSON:
        return {
    ...
    @classmethod
    def from_json(
        cls, obj: InterestRateConfigCompactJSON
