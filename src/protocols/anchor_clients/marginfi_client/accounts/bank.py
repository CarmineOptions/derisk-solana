...
class BankJSON(typing.TypedDict):
    ...
    emissions_flags: int
    emissions_rate: int
    emissions_remaining: types.wrapped_i80f48.WrappedI80F48JSON
    emissions_mint: str
    padding0: list[int]
    padding1: list[int]
...
class Bank:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "emissions_flags" / borsh.U64,
        "emissions_rate" / borsh.U64,
        "emissions_remaining" / types.wrapped_i80f48.WrappedI80F48.layout,
        "emissions_mint" / BorshPubkey,
        "padding0" / borsh.U128[28],
    ...
    def decode(cls, data: bytes) -> "Bank":
        ...
        return cls(
            ...
            group=dec.group,
            auto_padding_0=dec.auto_padding_0,
            ...
            auto_padding_1=dec.auto_padding_1,
            ...
            auto_padding_2=dec.auto_padding_2,
            ...
            emissions_flags=dec.emissions_flags,
            emissions_rate=dec.emissions_rate,
            emissions_remaining=types.wrapped_i80f48.WrappedI80F48.from_decoded(
                dec.emissions_remaining
            ),
    ...
    def to_json(self) -> BankJSON:
        return {
            ...
            "auto_padding_2": self.auto_padding_2,
            ...
            "emissions_flags": self.emissions_flags,
            "emissions_rate": self.emissions_rate,
            "emissions_remaining": self.emissions_remaining.to_json(),
            "emissions_mint": str(self.emissions_mint),
    ...
    def from_json(cls, obj: BankJSON) -> "Bank":
        return cls(
            ...
            auto_padding_2=obj["auto_padding_2"],
            ...
            emissions_flags=obj["emissions_flags"],
            emissions_rate=obj["emissions_rate"],
            emissions_remaining=types.wrapped_i80f48.WrappedI80F48.from_json(
                obj["emissions_remaining"]
            ),
            emissions_mint=Pubkey.from_string(obj["emissions_mint"]),
