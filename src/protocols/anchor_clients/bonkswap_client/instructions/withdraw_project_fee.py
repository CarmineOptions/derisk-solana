...
class WithdrawProjectFeeAccounts(typing.TypedDict):
    state: Pubkey
    pool: Pubkey
    token_x: Pubkey
    token_y: Pubkey
    project_owner_x_account: Pubkey
    project_owner_y_account: Pubkey
...
def withdraw_project_fee(
    accounts: WithdrawProjectFeeAccounts,
    ...
    keys: list[AccountMeta] = [
        ...
        AccountMeta(
            pubkey=accounts["project_owner_x_account"],
            is_signer=False,
            is_writable=True,
        ),
        AccountMeta(
            pubkey=accounts["project_owner_y_account"],
            is_signer=False,
            is_writable=True,
        ),
        AccountMeta(
        ...
        AccountMeta(pubkey=accounts["project_owner"], is_signer=True, is_writable=True),
        AccountMeta(
    ...
    identifier = b"\x82\xc9\x8e\x9c\x9f\xcf\xa8\x16"
    encoded_args = b""
