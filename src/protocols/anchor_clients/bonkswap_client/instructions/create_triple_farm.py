...
class CreateTripleFarmArgs(typing.TypedDict):
...
class CreateTripleFarmAccounts(typing.TypedDict):
    state: Pubkey
    pool: Pubkey
    farm: Pubkey
    token_x: Pubkey
...
def create_triple_farm(
    args: CreateTripleFarmArgs,
    accounts: CreateTripleFarmAccounts,
    ...
    keys: list[AccountMeta] = [
        ...
        AccountMeta(
            pubkey=accounts["token_project_second"], is_signer=False, is_writable=False
        ),
        AccountMeta(
    ...
    identifier = b"\x9a\x1a\xb4\x91\x12\xc9\x87\xab"
