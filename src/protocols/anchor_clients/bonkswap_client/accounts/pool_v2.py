...
class PoolV2JSON(typing.TypedDict):
    token_x: str
    token_y: str
    pool_x_account: str
    pool_y_account: str
    ...
    pool_bump: int
    lp_token: str
    lp_token_mint_bump: int
    padding: list[int]


@dataclass
class PoolV2:
    discriminator: typing.ClassVar = b"[\x0c\xd6W\x07\xb9\xa77"
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "pool_bump" / borsh.U8,
        "lp_token" / BorshPubkey,
        "lp_token_mint_bump" / borsh.U8,
        "padding" / borsh.U64[8],
    )
    token_x: Pubkey
    token_y: Pubkey
    ...
    async def fetch_multiple(
        ...
        commitment: typing.Optional[Commitment] = None,
        program_id: Pubkey = PROGRAM_ID,
    ) -> typing.List[typing.Optional["PoolV2"]]:
        infos = await get_multiple_accounts(conn, addresses, commitment=commitment)
        res: typing.List[typing.Optional["PoolV2"]] = []
        for info in infos:
            if info is None:
                res.append(None)
                continue
    ...
    @classmethod
    def decode(cls, data: bytes) -> "PoolV2":
        if data[:ACCOUNT_DISCRIMINATOR_SIZE] != cls.discriminator:
            raise AccountInvalidDiscriminator(
                "The discriminator for this account is invalid"
            )
        dec = PoolV2.layout.parse(data[ACCOUNT_DISCRIMINATOR_SIZE:])
        return cls(
            token_x=dec.token_x,
            token_y=dec.token_y,
            ...
            pool_bump=dec.pool_bump,
            lp_token=dec.lp_token,
            lp_token_mint_bump=dec.lp_token_mint_bump,
            padding=dec.padding,
        )

    def to_json(self) -> PoolV2JSON:
        return {
            ...
            "pool_bump": self.pool_bump,
            "lp_token": str(self.lp_token),
            "lp_token_mint_bump": self.lp_token_mint_bump,
            "padding": self.padding,
        }

    @classmethod
    def from_json(cls, obj: PoolV2JSON) -> "PoolV2":
        return cls(
            ...
            pool_bump=obj["pool_bump"],
            lp_token=Pubkey.from_string(obj["lp_token"]),
            lp_token_mint_bump=obj["lp_token_mint_bump"],
            padding=obj["padding"],
        )
