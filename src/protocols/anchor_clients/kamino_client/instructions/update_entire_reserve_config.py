...
class UpdateEntireReserveConfigArgs(typing.TypedDict):
    mode: int
    value: list[int]
...
class UpdateEntireReserveConfigAccounts(typing.TypedDict):
    lending_market_owner: Pubkey
    lending_market: Pubkey
    reserve: Pubkey


def update_entire_reserve_config(
    ...
    identifier = b"\x9d.\xba\xa0\xc59\x0b\xfd"
