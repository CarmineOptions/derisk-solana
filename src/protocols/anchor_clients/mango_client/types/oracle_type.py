...
class OrcaCLMMJSON(typing.TypedDict):
    kind: typing.Literal["OrcaCLMM"]
...
class OrcaCLMM:
    ...
    kind: typing.ClassVar = "OrcaCLMM"

    @classmethod
    def to_json(cls) -> OrcaCLMMJSON:
        return OrcaCLMMJSON(
            kind="OrcaCLMM",
        )
...
OracleTypeKind = typing.Union[Pyth, Stub, SwitchboardV1, SwitchboardV2, OrcaCLMM]
OracleTypeJSON = typing.Union[
    PythJSON, StubJSON, SwitchboardV1JSON, SwitchboardV2JSON, OrcaCLMMJSON
]
