...
class FlashLoanTokenDetailV3JSON(typing.TypedDict):
    token_index: int
    change_amount: int
    loan: int
...
class FlashLoanTokenDetailV3:
    ...
    @classmethod
    def from_decoded(cls, obj: Container) -> "FlashLoanTokenDetailV3":
        return cls(
    ...
    def to_json(self) -> FlashLoanTokenDetailV3JSON:
        return {
            "token_index": self.token_index,
            "change_amount": self.change_amount,
            "loan": self.loan,
    ...
    @classmethod
    def from_json(cls, obj: FlashLoanTokenDetailV3JSON) -> "FlashLoanTokenDetailV3":
        return cls(
            token_index=obj["token_index"],
            change_amount=obj["change_amount"],
            loan=obj["loan"],
